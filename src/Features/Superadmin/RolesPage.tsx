...
const permissionDescriptions: Record<Permission, string> = {
  ...
  [Permission.EDIT_TRANSACTION]: "Mengedit transaksi yang ada",
  [Permission.DELETE_TRANSACTION]: "Menghapus transaksi",
  [Permission.MANAGE_TRANSACTION_STATUS]: "Mengelola status transaksi",
  [Permission.MANAGE_TRANSACTION_TYPES]: "Mengelola tipe transaksi",
  [Permission.MANAGE_PAYMENT_METHODS]: "Mengelola metode pembayaran",
  [Permission.MANAGE_LOADERS]: "Mengelola data loader",
