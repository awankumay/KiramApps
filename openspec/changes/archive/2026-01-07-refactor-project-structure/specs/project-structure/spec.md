...
Spesifikasi struktur folder dan naming conventions untuk proyek React.js dengan arsitektur feature-first.
...
│       └── [FeatureName]Page.tsx # Page orchestrator
...
- Related to: Authentication capability (when implemented)
- Related to: Dashboard capability (when implemented)
- Supersedes: Previous layer-based structure (`components/`, `pages/`, `hooks/`)
