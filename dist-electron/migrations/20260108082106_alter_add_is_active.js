...
module.exports.up = async function ({ db }) {
    ...
    try {
        const paymentsCount = db
            ...
            .get();
        console.log("[Migration 20260108082106] Payments table exists with", paymentsCount.count, "rows");
    }
    catch (e) {
        console.log("[Migration 20260108082106] Payments table does not exist or error:", e.message);
    }
    try {
        const transactionsCount = db
            .prepare("SELECT COUNT(*) as count FROM transactions")
            .get();
        console.log("[Migration 20260108082106] Transactions table exists with", transactionsCount.count, "rows");
    }
    catch (e) {
        console.log("[Migration 20260108082106] Transactions table does not exist or error:", e.message);
    }
    // Check parent tables
    try {
        const paymentMethodsCount = db
            ...
            .get();
        console.log("[Migration 20260108082106] payment_methods has", paymentMethodsCount.count, "rows");
    }
    catch (e) {
        console.log("[Migration 20260108082106] payment_methods error:", e.message);
    }
    try {
        const transactionTypesCount = db
            .prepare("SELECT COUNT(*) as count FROM transaction_types")
            .get();
        console.log("[Migration 20260108082106] transaction_types has", transactionTypesCount.count, "rows");
    }
    catch (e) {
        console.log("[Migration 20260108082106] transaction_types error:", e.message);
    }
  ...
  `);
    console.log("[Migration 20260108082106] payment_methods_new created successfully");
    // Insert existing data into payment_methods_new
    console.log("[Migration 20260108082106] Inserting data into payment_methods_new...");
    db.exec(`
    INSERT INTO payment_methods_new (id, name, is_active, created_at)
    SELECT id, name, 1, created_at FROM payment_methods;
  `);
    console.log("[Migration 20260108082106] Data inserted into payment_methods_new");
    ...
    console.log("[Migration 20260108082106] Current foreign_keys status:", previousFkStatus);
    db.pragma("foreign_keys = OFF");
    console.log("[Migration 20260108082106] Foreign keys disabled temporarily");
    // Remove old payment_methods table
    console.log("[Migration 20260108082106] Dropping old payment_methods table...");
    try {
        db.exec(`DROP TABLE payment_methods;`);
        console.log("[Migration 20260108082106] Old payment_methods dropped successfully");
    }
    catch (e) {
        console.error("[Migration 20260108082106] ERROR dropping payment_methods:", e.message);
        throw e;
    }
    // Rename new table to payment_methods
    console.log("[Migration 20260108082106] Renaming payment_methods_new to payment_methods...");
    db.exec(`ALTER TABLE payment_methods_new RENAME TO payment_methods;`);
    console.log("[Migration 20260108082106] payment_methods renamed successfully");
  ...
  `);
    console.log("[Migration 20260108082106] transaction_types_new created successfully");
    // Insert existing data into transaction_types_new
    console.log("[Migration 20260108082106] Inserting data into transaction_types_new...");
    db.exec(`
    INSERT INTO transaction_types_new (id, name, is_active, created_at)
    SELECT id, name, 1, created_at FROM transaction_types;
  `);
    console.log("[Migration 20260108082106] Data inserted into transaction_types_new");
    ...
    console.log("[Migration 20260108082106] Current foreign_keys status:", previousFkStatus2);
    db.pragma("foreign_keys = OFF");
    console.log("[Migration 20260108082106] Foreign keys disabled temporarily");
    // Remove old transaction_types table
    console.log("[Migration 20260108082106] Dropping old transaction_types table...");
    try {
        db.exec(`DROP TABLE transaction_types;`);
        console.log("[Migration 20260108082106] Old transaction_types dropped successfully");
    }
    catch (e) {
        console.error("[Migration 20260108082106] ERROR dropping transaction_types:", e.message);
        throw e;
    }
    // Rename new table to transaction_types
    console.log("[Migration 20260108082106] Renaming transaction_types_new to transaction_types...");
    db.exec(`ALTER TABLE transaction_types_new RENAME TO transaction_types;`);
    console.log("[Migration 20260108082106] transaction_types renamed successfully");
    // Restore foreign keys status
