...
export async function up({ db }) {
  ...
  `);
    ...
    // Transaction indexes
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transactions_invoice_number ON transactions(invoice_number)`);
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transactions_customer_id ON transactions(customer_id)`);
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transactions_vehicle_id ON transactions(vehicle_id)`);
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transactions_transaction_type_id ON transactions(transaction_type_id)`);
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transactions_payment_status ON transactions(payment_status)`);
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transactions_transaction_status ON transactions(transaction_status)`);
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transactions_created_by ON transactions(created_by)`);
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transactions_created_at ON transactions(created_at)`);
    // Transaction items indexes
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transaction_items_transaction_id ON transaction_items(transaction_id)`);
    db.exec(`CREATE INDEX IF NOT EXISTS idx_transaction_items_item_id ON transaction_items(item_id)`);
    // Payments indexes
